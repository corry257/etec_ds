...
**Linguagem java**
 ...
 - Estrutura de decisão: SWITCH / CASE 
   ...
   ---
   # Aula 04 - 10/03/2025
   - O professou passou uma atividade que consiste em:
   - Criar um JOptionPane / Switch Case  
1 - MB - Muito bom - Aprovado
2 - B - Bom - Aprovado
3 - R - Regular - Recuperação
4 - I - Irregular - Repetente 
Diferente desta menções, 
Menção Inválida
...
# Segunda atividade: 
- Instruções
Exiba os canais de televisão de acordo com o seletor de canais
...
Diferente disso: "Canal não existe"
